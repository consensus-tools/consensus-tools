...
import { ensureNonNegative, getBalance } from "../ledger/rules.js";
...
export class JobEngine {
  ...
  constructor(
    ...
    // Accept an optional PolicyResolver; fall back to the built-in resolver.
    this.resolver = resolver ?? resolveConsensus;
  }
